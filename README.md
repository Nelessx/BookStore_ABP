...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6e26fa5c-b50b-4d45-9db3-980f56a2b2d4
```

> `6e26fa5c-b50b-4d45-9db3-980f56a2b2d4` is the password of the certificate, you can change it to any password you want.
